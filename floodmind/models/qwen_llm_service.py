...
from floodmind.agent.runtime.contracts.messages import Message, ai_message
    ...
    def stream_with_reasoning(
        ...
        **kwargs: Any,
        ...
        if self.enable_thinking:
            existing_body = extra_kwargs.get("extra_body", {}) or {}
            existing_body["enable_thinking"] = True
            extra_kwargs["extra_body"] = existing_body
